...
public class BackupMongoS {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                System.out.println("S: " + flag++ + " - " + FileName);
                if ((iOPk != null && iOBkp == null)) {
                    ...
                    System.out.println("id_documento_s: " + FileName);
    ...
    private static void conexionMongo() {
        try {
            ...
            collectionBkp = dbBkp.getCollection("documento_s_anexo");
            gfsPhotoBkp = new GridFS(dbBkp, "documento_s_anexo");
            //
            mongoPk = new Mongo("remoto", 27017);
            dbPk = mongoPk.getDB("db");
            collectionPk = dbPk.getCollection("documento_s_anexo");
            gfsPhotoPk = new GridFS(dbPk, "documento_s_anexo");
        } catch (UnknownHostException ex) {
            System.out.println("S ");
            Logger.getLogger(BackupMongoS.class.getName()).log(Level.SEVERE, null, ex);
            ex.printStackTrace();
