...
public class BackupMongoM {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                System.out.println("M: " + flag++ + " - " + FileName);
                if ((iOPk != null && iOBkp == null)) {
                    ...
                    System.out.println("id_documento_m: " + FileName);
    ...
    private static void conexionMongo() {
        try {
            ...
            collectionBkp = dbBkp.getCollection("documento_m_anexo");
            gfsPhotoBkp = new GridFS(dbBkp, "documento_m_anexo");
            //
            mongoPk = new Mongo("remoto", 27017);
            dbPk = mongoPk.getDB("db");
            collectionPk = dbPk.getCollection("documento_m_anexo");
            gfsPhotoPk = new GridFS(dbPk, "documento_m_anexo");
        } catch (UnknownHostException ex) {
            System.out.println("M ");
            Logger.getLogger(BackupMongoM.class.getName()).log(Level.SEVERE, null, ex);
            ex.printStackTrace();
